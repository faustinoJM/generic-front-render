...
import DatatableInputINSS from "../../components/datatableResources/DatatableInputINSS"


const payrollInputColumns = [
    { field: 'employee_id', headerName: 'ID', width: 70, align:'center', headerAlign: 'center', hide: true},
    { field: "social_security",  headerName: "Num. Benificiario", width: 180,  align:'center', headerAlign: 'center',},
    ...
    { field: "absences",  headerName: "Dias", width: 100, align:'center', headerAlign: 'center'},
    ...
    { field: "inss_event", headerName: "Evento", width: 150, editable: true, align:'center', headerAlign: 'center',},
    { field: "inss_event_date", headerName: "Data do Evento", width: 150, align:'center', headerAlign: 'center',},
...
const ListInputINSS = ({ listName, listPath }) => {
        ...
        async function fetchData() {
            ...
            //  console.log(response.data.data)
             ...
             response.data.map((data) => {
                ...
                data.absences = 30 - data.absences 
