...
const PrintPayslipBatch = ({componentRef, printData}) => {
                                        ...
                                        <div>
                                            ...
                                            <div className="wrapper-div">
                                                <div className="column-head">
                                                    ...
                                                    <span style={{fontWeight: "700"}}>Salario Groso</span>
                                                    <span>IRPS</span>
                                                    <span>INSS</span>
                                                    <span>Sindicato</span>
                                                    <span>IPA</span>
                                                ...
                                                <div className="column-data">
                                                    ...
                                                    <span>{formatSalary().format(single.total_overtime)}</span>
                                                    <span>{formatSalary().format(single.bonus)}</span>
                                                    <span>{single.subsidy_vacation}</span>
                                                    <span>{formatSalary().format(single.subsidy)}</span>
                                                    <span>{formatSalary().format(single.subsidy_food)}</span>
                                                    <span>{formatSalary().format(single.backpay)}</span>
                                                    ...
                                                    <span>{formatSalary().format(single.syndicate_employee)}</span>
                                                    <span>{formatSalary().format(single.syndicate_employee)}</span>
                                                    <span>{formatSalary().format(single.cash_advances)}</span>
                                        ...
                                        <div>
                                            ...
                                            <div className="wrapper-div">
                                                ...
                                                <div className="column-data">
                                                    ...
                                                    <span>{single.subsidy_vacation}</span>
                                                    <span>{formatSalary().format(single.subsidy)}</span>
                                                    <span>{formatSalary().format(0)}</span>
                                                    <span>{formatSalary().format(single.backpay)}</span>
                                                    <span style={{fontWeight: "700"}}>{formatSalary().format(single.total_income)}</span>
                                                    <span>{formatSalary().format(single.irps)}</span>
                                                    <span>{formatSalary().format(single.inss_employee)}</span>
    ...
    return (
        <div style={{display: "none"}}>
            {printSlapType(setting.payslip_type)}
        </div>
    )
}
